...
export default async function CalendarPage({ params }: CalendarPageProps) {
  ...
  const events = [
    ...
    },
    {
      ...
      subtitle: locale === "ro" ? "Balul lui Gatsby – Mister și suspans în anii '20" : "Gatsby's Ball – Mystery and suspense in the '20s",
      date: "26",
      month: "Apr",
      year: "2026",
      time: "16:30",
      ...
      gradient: "from-plum-700/20 to-plum-500/20",
      description: locale === "ro"
        ? "O seară glam, plină de mister și suspans, construită în jurul unei povești din anii '20. Primești un personaj și devii parte din intrigă. Dress code: Interbelic – Dress to impress!"
        : "A glamorous evening full of mystery and suspense, built around a 1920s story. You receive a character and become part of the intrigue. Dress code: 1920s – Dress to impress!",
