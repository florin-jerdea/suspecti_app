  ...
  const events = [
    {
      ...
      link: "https://www.ambilet.ro/bilete/suspecti-in-treasure-hunt-family-edition-bucuresti-4572" as string | null,
    ...
    },
    {
      ...
      link: "https://www.ambilet.ro/bilete/suspecti-in-treasure-hunt-aduls-only-bucuresti-4573",
    ...
    },
    {
      ...
      description: locale === "ro"
        ? "Aventură, mister și distracție în oraș pentru familii și copii de minim 8 ani. Rezolvă indiciile, îndeplinește misiunile și transformăm orașul într-o aventură."
        : "Adventure, mystery and fun in the city for families and kids aged 8+. Solve the clues, complete the missions and we'll turn the city into an adventure.",
      link: "https://www.ambilet.ro/bilete/suspecti-in-treasure-hunt-family-edition-timisoara-4516",
      status: "available" as const,
    },
    {
      id: 16,
      ...
      description: locale === "ro"
        ? "Aventură, mister și distracție în oraș, ediție pentru adulți. Rezolvă indiciile, îndeplinește misiunile și transformăm orașul într-o aventură."
        : "Adventure, mystery and fun in the city, adults edition. Solve the clues, complete the missions and we'll turn the city into an adventure.",
      link: "https://ambilet.ro/bilete/suspects-in-treasure-hunt-aduls-only-timisoara-4527",
      status: "available" as const,
    },
    {
      id: 17,
      title: locale === "ro" ? "Suspecți la Cină" : "Suspecți at Dinner",
      subtitle: "Cartels, Diamonds & Tropical Secrets 💎🌴",
      date: "21",
      month: locale === "ro" ? "Iun" : "Jun",
      year: "2026",
      time: "16:30 – 20:30",
      ...
      description: locale === "ro"
        ...
        : "A mystery evening with characters, secrets and tropical intrigues, in an elegant rooftop atmosphere.",
      link: "https://www.ambilet.ro/bilete/suspecti-la-cina-diamonds-cartels-tropical-secrets-4528",
      status: "available" as const,
    },
    {
      id: 18,
      title: locale === "ro" ? "Suspecți la Povești" : "Suspecți Stories",
      subtitle: locale === "ro" ? "with a touch of Tarot" : "with a touch of Tarot",
      date: "25",
      month: locale === "ro" ? "Iun" : "Jun",
      year: "2026",
      time: "19:00",
      ...
      link: "https://www.ambilet.ro/bilete/suspecti-la-povesti-cu-tarot-4520",
      status: "available" as const,
    },
    {
      id: 21,
